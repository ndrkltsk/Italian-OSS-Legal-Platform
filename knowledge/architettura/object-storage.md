---
type: Componente
title: Object storage (S3-compatibile)
description: MinIO, object storage open source compatibile S3, in self-hosting per documenti utente e artefatti di ingest.
resource: https://min.io/
tags: [storage, minio, s3, self-hosting]
